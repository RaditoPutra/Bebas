...
model_directory = r'D:\Tugas\Sem 5\Mesin Learning\UGD'
...
if os.path.exists(model_path):
    try:
        ...
        diabetesPedigreeFunction = st.slider("Diabetes Pedigree Function", min_value=0.07, max_value=2.42, step=0.01)
